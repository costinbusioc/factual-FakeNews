...
train_files = ["FactualDatasets/factual_train_25.csv"]
test_files = ["FactualDatasets/factual_test_25.csv"]
class_weights = "factual75"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-name", type=str, default="readerbench/RoBERT-base")
